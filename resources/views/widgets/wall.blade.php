    ...
    <div class="panel-body">
        <form id="form-new-post">
            ...
            <input type="hidden" name="title" value="{{ $title ??
                '.'}}">
            <textarea name="content" placeholder="ajouter un description a votre média..." id="textarea"></textarea>
            ...
            <div class="row">
                <div class="col-xs-4">
                    <button type="button" class="btn btn-default btn-add-image btn-sm" onclick="uploadPostImage()">
                        <i class="fa fa-image"></i> Ajouter des médias
                    </button>
                    <input type="file"  class="image-input"  multiple name="photo" onchange="previewPostImage(this)">
                </div>
