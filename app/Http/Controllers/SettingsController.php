...
class SettingsController extends Controller
{
    ...
    public function update(Request $request){
        ...
        if ($save){
            $request->session()->flash('alert-success', 'Vos coordonnées ont été mises à jour avec succès!');
        }else{
            $request->session()->flash('alert-danger', ($additional_msg)?$additional_msg:'Problèmes d"enregistrement de vos données');
        }
